// Lightweight logging facade for the desktop UI: console + Sentry (breadcrumbs for
// info/warn, captured exceptions for error). No-op-safe when Sentry is disabled.
// Never log secrets — command names / timings / ids only.
