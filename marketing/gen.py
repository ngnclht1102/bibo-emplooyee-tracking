"""Generate marketing graphics for Employee Tracker.
...
def social():
    ...
    d.text((250, 110), "Employee Tracker", font=font(58, bold=True), fill=WHITE)
...
def hero():
    ...
    d.text((wx0 + 56 * ss, cy0 + 24 * ss), "Employee Tracker", font=font(18 * ss, bold=True), fill=INK)
